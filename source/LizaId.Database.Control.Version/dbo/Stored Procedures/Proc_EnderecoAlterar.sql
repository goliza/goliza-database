CREATE PROCEDURE [dbo].[Proc_EnderecoAlterar] @idEndereco int,
    ...
    @ComplementoEndereco varchar(MAX) = NULL,
...
BEGIN
	UPDATE [dbo].[Endereco]
	SET    [DescricaoEndereco] = @DescricaoEndereco, [idPaisEndereco] = @idPaisEndereco, [CEPEndereco] = @CEPEndereco, [CaixaPostalEndereco] = @CaixaPostalEndereco, [UFEndereco] = @UFEndereco, [LogradouroEndereco] = @LogradouroEndereco, [NumeroEndereco] = @NumeroEndereco, [ComplementoEndereco] = @ComplementoEndereco, [BairroEndereco] = @BairroEndereco, [CidadeEndereco] = @CidadeEndereco, [Cnpj] = @Cnpj,[DataAlteracao] = GETDATE()
